...
/**
 * 
 * @author Zhou 文件上传控制类 codeDictionary 行业代码库上传
 */
@Controller
...
public class FileUploadController {
	...
	@ResponseBody
	public void codeDictionaryUpload(MultipartFile file, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public void GCorfficientMath(HttpServletRequest request, HttpServletResponse response, @RequestBody String json) {
		...
		Double yearAvergeSpendDay = Double.valueOf(map.get("yearAvergeSpendDay"));// 年均消费天数
		...
		if (corfficientExits) {
			...
			deleteService.DeleteTravelTax(year, place);
			deleteService.DeleteTravelGdp(year, place);
			System.out.println(corfficientExits);
		} else {
	...
	public void landTaxUpload(MultipartFile file, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		response.setContentType("text/html;charset=utf-8");
		String path = "D:\\Users";
		HttpSession session = request.getSession();
	...
	public void centralTaxUpload(MultipartFile file, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		response.setContentType("text/html;charset=utf-8");
		String path = "D:\\Users";
		HttpSession session = request.getSession();
	...
	public void gdpUpload(MultipartFile file, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
