...
function register_event() {
	...
	$(".login-bt").click(
			function() {
				...
				checkLoginInfo(username, password, userpower, year, province,
						city, county);
			});
}
...
// 登录信息审核
function checkLoginInfo(username, password, userpower, year, province, city,
		county) {
	city = city.replace(" ", "");
	var url = '/Statistic/User/userindex';
	var json = '{';
